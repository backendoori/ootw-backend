...
class PostServiceTest {
    ...
    class Save {
        ...
        void saveSuccess() {
            ...
            // when
            PostSaveResponse postSaveResponse = postService.save(request, postImg, authentication.getPrincipal());
        ...
        void saveFailNotSavedUser() {
            ...
            assertThrows(NoSuchElementException.class,
                () -> postService.save(postSaveRequest, postImg, authentication.getPrincipal()));
        }

...
class AuthenticationControllerTest {
    ...
    class SignupTest {
        ...
        void created() throws Exception {
            ...
            given(authenticationService.signup(signupDto)).willReturn(userDto);
        ...
        void unauthorizedAlreadyExistEmail() throws Exception {
            ...
            given(authenticationService.signup(signupDto)).willThrow(new AlreadyExistEmailException());
    ...
    class LoginTest {
        ...
        void created() throws Exception {
            ...
            given(authenticationService.login(loginDto)).willReturn(tokenDto);
        ...
        void unauthorizedNotExistUser() throws Exception {
            ...
            given(authenticationService.login(loginDto)).willThrow(new NotExistUserException());
        ...
        void unauthorizedIncorrectPassword() throws Exception {
            ...
            given(authenticationService.login(loginDto)).willThrow(new IncorrectPasswordException());

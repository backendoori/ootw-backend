...
public class PostValidator {
    ...
    private static void validateTitle(String title) {
        ...
        AssertUtil.isFalse(title.length() > MAX_TITLE_LENGTH, INVALID_POST_TITLE);
    }

    private static void validateContent(String content) {
        AssertUtil.notBlank(content, BLANK_POST_TITLE);
        AssertUtil.isFalse(content.length() > MAX_CONTENT_LENGTH, INVALID_POST_CONTENT);
    }
